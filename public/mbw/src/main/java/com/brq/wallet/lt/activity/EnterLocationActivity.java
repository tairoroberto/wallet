...
import com.brq.wallet.activity.util.DelayAutoCompleteTextView;
...
import com.brq.wallet.lt.AddressDescription;
...
public class EnterLocationActivity extends Activity {
   ...
   private GpsLocationFetcher.GpsLocationEx address2Location(AddressDescription addr) {
      return new GpsLocationFetcher.GpsLocationEx(addr.location.getLatitude(), addr.location.getLongitude(), addr.toString(),
