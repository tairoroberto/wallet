...
import com.brq.wallet.lt.activity.sell.CreateOrEditAdActivity;
...
public class SendRequestActivity extends Activity {
   ...
   private LocalTraderEventSubscriber ltSubscriber = new LocalTraderEventSubscriber(new Handler()) {
      ...
      @Override
      public void onLtAdRetrieved(com.mycelium.lt.api.model.Ad ad, GetAd request) {
