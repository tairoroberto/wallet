...
import com.brq.wallet.GpsLocationFetcher;
...
public class LocalTraderManager {
   ...
   public LocalTraderManager(Context context, TradeSessionDb db, LtApi api, MbwManager mbwManager) {
      ...
      _currentLocation = new GpsLocationFetcher.GpsLocationEx(
   ...
   public void setLocation(GpsLocationFetcher.GpsLocationEx location) {
      SharedPreferences.Editor editor = getEditor();
